          ...
          {userType === "admin" ? (
            <div className="admin_sec">
             ...
             <div class="input-box underline">
                <input type="text" value={userId} placeholder="Enter Your Email" onChange={(e)=>setUserId(e.target.value)} required/>
                <div class="underline"></div>
                </div>
                <div class="input-box">
                    <input type="password" value={adminPassword} onChange={(e)=>setAdminPassword(e.target.value)} placeholder="Enter Your Password" required/>
                    <div class="underline"></div>
                </div>
            </div>
          ) : (
